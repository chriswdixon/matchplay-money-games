...
export default function Profile() {
  ...
  const SectionHeader = ({ title }: { title: string }) => (
    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-3 pb-4 border-b">
  ...
  return (
    <div className="app-page-bg flex flex-col">
      ...
      <main
        id="profile-main"
        role="main"
        className="flex-1 max-w-3xl w-full mx-auto px-4 md:px-6 pt-6 md:pt-24 pb-32 md:pb-8"
      >
